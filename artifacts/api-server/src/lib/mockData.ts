...
export const mockProviders: ProviderStatus[] = [
  ...
  },
  {
    ...
    status: "live",
    lastChecked: new Date().toISOString(),
    description: "Public ESPN team roster API — real player IDs, positions, headshots. Used to generate props for actual rostered players.",
    mockMode: false,
  },
  {
    ...
    status: "mock",
    lastChecked: new Date().toISOString(),
    description: "PrizePicks does not expose a public API. Their projections endpoint requires their app's auth and is rate-limited per device. We do not bypass protected APIs. Props shown are algorithmically generated from real player data — see notice in app footer.",
    mockMode: true,
  },
  {
